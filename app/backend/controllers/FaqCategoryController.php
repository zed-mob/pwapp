...
use common\models\FaqCategoryQuery;
...
class FaqCategoryController extends Controller
{
    ...
    public function actionIndex()
    {
        ...
        $searchModel = new FaqCategoryQuery();
            ...
            */
            ...
            if($request->isGet){
                ...
                return [
                    ...
                    'title'=> "Create new FaqCategory",
                    'content'=>'<span class="text-success">Create FaqCategory success</span>',
                    'footer'=> Html::button('Close',['class'=>'btn btn-default pull-left','data-dismiss'=>"modal"]).
    ...
    /**
     * Delete an existing FaqCategory model.
     * For ajax request will return json object
    ...
    public function actionDelete($id)
    {
     ...
     /**
     * Delete multiple existing FaqCategory model.
     * For ajax request will return json object
     * and for non-ajax request if deletion is successful, the browser will be redirected to the 'index' page.
     * @param integer $id
     * @return mixed
